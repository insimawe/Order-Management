...
💬 Real-time communication with customers regarding order progress 
    E.g., Order Placed → Confirmed → Out for Delivery → Order Received  
🧾 Coupons: Create and manage discount vouchers for promotional use  
🍕 Foods: Add, update, or delete food items from the menu  
